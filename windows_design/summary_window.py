...
class Ui_summary(object):
    def setupUi(self, summary):
        ...
        self.data = QAction(summary)
        self.data.setObjectName(u"data")
        self.data.setAutoRepeat(False)
        self.action_4 = QAction(summary)
        self.action_4.setObjectName(u"action_4")
        self.exit = QAction(summary)
    ...
    def retranslateUi(self, summary):
        ...
        self.data.setText(QCoreApplication.translate("summary", u"\u0414\u0430\u043d\u043d\u044b\u0435", None))
#if QT_CONFIG(shortcut)
        self.data.setShortcut(QCoreApplication.translate("summary", u"Ctrl+2", None))
...
#endif // QT_CONFIG(shortcut)
        self.exit.setText(QCoreApplication.translate("summary", u"\u0412\u044b\u0445\u043e\u0434", None))
#if QT_CONFIG(shortcut)
        self.exit.setShortcut(QCoreApplication.translate("summary", u"Ctrl+X", None))
#endif // QT_CONFIG(shortcut)

...
#endif // QT_CONFIG(shortcut)
        self.exit.setText(QCoreApplication.translate("reports", u"\u0412\u044b\u0445\u043e\u0434", None))
#if QT_CONFIG(shortcut)
        self.exit.setShortcut(QCoreApplication.translate("reports", u"Ctrl+X", None))
#endif // QT_CONFIG(shortcut)
